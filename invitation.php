...
<body>
	...
	<div id="navbar" style="display: flex; justify-content: space-between; width=100%; height=50px; margin-bottom:16px; background-color:black; color:gold; margin-top:0px;  text-align: left; ">
		<ul style="width:100%;">
			...
			<li id="broadcastReminder" style="display:inline; margin-right:30px;"><a href="broadcast_deadline_reminder.php?page=invitation" style="color:white; text-decoration: underline;">Broadcast Reminder</a></li>
		</ul>
		<ul>
...
<input type="text" style="width:220x"; name="email" value="">


<br /><br />
<b>Subject:</b> 
<br />
<input type="text" style="width:220x"; name="subject" value="Account Invitation" readonly="readonly">
<br /><br />
<b>Message:</b> 
<br />
...
<a href ="http://localhost:8000/register.php">Register Account</a>
...
<img src="./ucf-l.png" alt="UCF" style=" width:160px; height:160px; display:block; margin-left: 0%; position: relitive; margin-top:28px;">
</body>
</html>